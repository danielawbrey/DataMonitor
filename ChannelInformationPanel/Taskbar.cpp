...
Taskbar::Taskbar(QFrame *parent) : QFrame(parent) {
    ...
    QIcon infoIcon("../DataMonitor/Images/tv.jpg");
    ...
    QIcon commsIcon("../DataMonitor/Images/comms.png");
    ...
    QIcon dataIcon("../DataMonitor/Images/data.jpg");
    ...
    QIcon hideIcon("../DataMonitor/Images/exit.png");
